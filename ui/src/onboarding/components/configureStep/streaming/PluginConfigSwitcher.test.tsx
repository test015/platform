...
// Constants
import {telegrafPlugin, token} from 'src/onboarding/constants/resources'
...
const setup = (override = {}) => {
  const props = {
    ...
    onAddTelegrafPluginConfigFieldValue: jest.fn(),
    onRemoveTelegrafPluginConfigFieldValue: jest.fn(),
    ...override,
  }
